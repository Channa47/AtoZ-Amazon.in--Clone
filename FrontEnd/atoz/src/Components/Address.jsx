      ...
      {isLoading ? (
        ...
        <>
          ...
          >
            ...
            <Text border="0px" ml={[8, 20, 40, 60, 400, 500]}>
              Checkout
            </Text>
          </Box>
            ...
            <Flex>
              <Box>
                <Grid templateColumns="repeat(1,1fr)" gap={6}>
                  <GridItem w="80%" h="10" ml={[3, 5, 50, 50, 150, 150]}>
                    <SimpleGrid
                      columns={["2", "1", "1", "1", "1", "1"]}
                      spacing={0}
                    >
                                  ...
                                  <Stack direction="column">
                                    <Box>
                                      <Radio value="1">
                                        ...
                                        <Text>
                                          Flat no.810, Model apartment,
                                          Kahilipara road, Guwahati, Assam,
                                          781086, India,
                                        </Text>
                                    ...
                                    <Box>
                                      <Radio value="2">
                                        ...
                                        <Text>
                                          House no.10, M.G road, Delhi, Delhi,
                                          481086, India,
                                        </Text>
